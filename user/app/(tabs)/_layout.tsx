import { Person, Compass } from "@/assets/icons/person";
import { CompassLight } from "@/assets/icons/compassLight";
        ...
        return {
          ...
          tabBarIcon: ({ focused }) => {
            ...
            if (route.name === "home") {
              ...
              if (focused) {
                iconName = <Compass colors={color.buttonBg} width={24} height={24} />;
              } else {
                iconName = <CompassLight />;
              }
